<h2><a href="https://leetcode.com/problems/sentence-similarity-iii/description/?envType=problem-list-v2&envId=vje3f39g">1923. Sentence Similarity III</a></h2><h3>Medium</h3><hr><p>You are given two strings <code>sentence1</code> and <code>sentence2</code>, each representing a <strong>sentence</strong> composed of words. A sentence is a list of <strong>words</strong> that are separated by a <strong>single</strong> space with no leading or trailing spaces. Each word consists of only uppercase and lowercase English characters.</p>
